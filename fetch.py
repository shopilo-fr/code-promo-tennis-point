#!/usr/bin/env python3
"""
Recuperation des codes promo Tennis-Point depuis shopilo.fr
Sursa: https://shopilo.fr/reductions/tennis-point.fr
"""
...
SHOPILO_URL = "https://shopilo.fr/reductions/tennis-point.fr"
STORE_NAME = "Tennis-Point"


def fetch_coupons(url=SHOPILO_URL):
    """Renvoie la liste des coupons actifs pour Tennis-Point depuis shopilo.fr"""
    headers = {
        "User-Agent": "Mozilla/5.0 (compatible; coupon-fetcher/1.0; +https://github.com/shopilo-fr/code-promo-tennis-point)"
    }
    try:
